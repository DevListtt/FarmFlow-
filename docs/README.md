...
Le premier socle transverse est exposé via `/pilotage/*` pour fournir la synthèse, les simulateurs, l'analyse bancaire préparatoire et le catalogue d'exports réglementaires.
