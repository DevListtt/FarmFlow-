        ...
        "references": [
            {
                ...
                "a_integrer": ["PostGIS", "couts par atelier", "exports robustes", "piste audit"],
            },
            {
                "nom": "farmOS",
                "apport": "registre terrain avec assets, logs et observations",
                "a_integrer": ["journal terrain", "observations mobiles", "historique parcelle", "API terrain"],
            },
            {
                "nom": "LiteFarm",
